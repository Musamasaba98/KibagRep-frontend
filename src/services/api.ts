...
export const submitDailyReportApi = (data: { summary?: string; jfw_observer_id?: string; jfw_observer_ids?: string[]; report_date?: string; report_id?: string }) => api.post('/daily-report/submit', data);
