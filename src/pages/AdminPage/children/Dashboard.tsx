                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          disabled={actioning === e.id}
                          className="flex items-center gap-1 px-3 py-1.5 text-xs font-bold rounded-lg bg-red-50 text-red-600 hover:bg-red-100 active:bg-red-200 disabled:opacity-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-red-400"
                          style={{ transition: "background-color 0.15s" }}
                        >
      ...
      <div className="bg-white rounded-2xl border border-gray-50 shadow-sm shadow-gray-100">
        ...
        {loading ? (
          ...
          <div className="divide-y divide-gray-50">
            {teams.map((t) => (
              <div key={t.id} className="flex items-center gap-4 px-6 py-4 hover:bg-gray-50/60">
