...
const Sidebar = ({ onNav }: { onNav?: () => void }) => {
  ...
  const masterDataLinks = [
    ...
    { to: "/admin/my-pharmacies",         icon: FaHospital,           label: "My Pharmacies",      showBadge: false },
    ...
    { to: "/admin/my-facilities",         icon: FaBuildingColumns,    label: "My Facilities",      showBadge: false },
