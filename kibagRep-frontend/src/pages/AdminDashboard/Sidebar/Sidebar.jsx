...
const Sidebar = () => {
  ...
  return (
    ...
    <div className='fixed bg-white transition-width duration-[1s] w-[22%] 2xl:w-[15%] h-screen border-solid border-r-[1px] border-grey-200'>
    
   {/* Div for the links */}
    <div className="flex flex-col gap-[18px] 2xl:gap-3">
